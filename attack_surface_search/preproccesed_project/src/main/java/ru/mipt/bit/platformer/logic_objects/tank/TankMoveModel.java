...
@ Override public GridPoint2 getDestination ( )
{
...
@ Override public void updateFireProgress ( )
{
shootProgress + = 1;
...
@ Override public boolean mayShoot ( )
{
return shootProgress == 0;
}
@ Override public void finishShooting ( )
{
shootProgress = 0;
isShooting = false;
}
...
@ Override public void setMovingStatus ( boolean status )
{
...
@ Override public void switchHealthBar ( )
{
if ( waitSwitching )
{
waitSwitching = false;
...
this . healthBarCur = 0;
System . out . println ( "switchHealthBar\n" + "    now is rase: " + isHealthBarRaise + "    health bar cur: " + healthBarCur );
}
...
@ Override public void mainUpdateProgress ( float deltaTime )
{
if ( isMoving )
{
...
@ Override public boolean isHealthBarRaise ( )
{
