...
this . destinationCoordinates = new GridPoint2 ( tankMoveModel . getCoordinates ( ) . x + direction . getVector ( ) . x , tankMoveModel . getCoordinates ( ) . y + direction . getVector ( ) . y );
}
@ Override public boolean isFinished ( )
{
return isFinished;
}
@ Override public void execute ( Level level )
{
...
if ( newCoordinates . x < level . getLeftBound ( ) || newCoordinates . x > level . getRightBound ( ) || newCoordinates . y < level . getLowBound ( ) || newCoordinates . y > level . getUpBound ( ) )
{
return false;
}
