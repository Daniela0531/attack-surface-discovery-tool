...
this . playerTank = new TankMoveModel ( map . getPlayer ( ) . getCoordinates ( ) , 0f , logicProperties . getTankMaxHealth ( ) , logicProperties . getTankSpeed ( ) );
this . playerGraphics = new GraphicsForMovementLivableDecorator ( graphicProperties . getTankTexture ( ) , graphicProperties . getHealthBarDecorator ( ) , playerTank );
...
{
TankMoveModel tankMoveModel = new TankMoveModel ( mapNode . getCoordinates ( ) , 0f , logicProperties . getTankMaxHealth ( ) , logicProperties . getTankSpeed ( ) );
GraphicsForMovementLivableDecorator graphics = new GraphicsForMovementLivableDecorator ( graphicProperties . getTankTexture ( ) , graphicProperties . getHealthBarDecorator ( ) , tankMoveModel );
...
{
BulletMoveModel bulletMoveModel = new BulletMoveModel ( coord , direction , logicProperties . getBulletDamage ( ) , logicProperties . getBulletSpeed ( ) );
...
{
tileMovement . moveRectangleBetweenTileCenters ( rectangle , node . getCoordinates ( ) , node . getDestination ( ) , node . getProgress ( ) );
}
public void dispose ( )
{
tiledMap . dispose ( );
