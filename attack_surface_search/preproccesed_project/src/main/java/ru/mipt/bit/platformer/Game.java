...
public Game ( ButtonHandler buttonHandler , LogicExecutor logicExecuter , CommandQueue commandQueueHandler , GeneratorActions generatorActions , Level level , GraphicProperties graphicProperties )
{
