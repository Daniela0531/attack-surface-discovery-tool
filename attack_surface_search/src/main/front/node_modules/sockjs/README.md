...
You need to start a second web server (by default listening on 8000)
...
8081 and sockjs-client on 8000. When you open the browser on
[http://localhost:8000/](http://localhost:8000/) you should be able
